"""
replay アプローチをベースに以下の要素を追加
・Machine Unlearning の考慮
"""
...
class BaselineMu(BaseLearner):
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            if epoch % 5 == 0:
                ...
                info = "Task {}, Epoch {}/{} => Loss {:.3f}, Loss_clf {:.3f}, Loss_forg {:.3f}, Train_accy {:.2f}, Test_accy {:.2f}".format(
                    self._cur_task,
                    epoch + 1,
                    self.init_epoch,
                ...
                info = "Task {}, Epoch {}/{} => Loss {:.3f}, Loss_clf {:.3f}, Loss_forg {:.3f}, Train_accy {:.2f}".format(
                    self._cur_task,
                    epoch + 1,
                    self.init_epoch,
                    losses / len(train_loader),
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                # ② 損失計算
                # ----------------------------------------
                logits, loss_clf, loss_forg = self.compute_loss(inputs, targets)
                loss = loss_clf * self.lambda_clf + loss_forg * self.lambda_forg
    ...
    def compute_loss(self, inputs, targets):
        ...
        return logits, loss_clf, loss_forg
